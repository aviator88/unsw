...
class Networks:
    ...
    Story_Iliad = Network(
        ...
        rpc='https://1513.rpc.thirdweb.com',
        chain_id=1513,
        tx_type=2,
        coin_symbol='IP',
        decimals=18,
        ...
        # api=API(
        #     key=config.STORY_ILIAD_API_KEY, url='https://api-sepolia.uniscan.xyz/api',
        #     docs='https://testnet.storyscan.xyz/api-docs'
        # )
    )
    ...
    Unichain_Sepolia = Network(
        ...
        api=API(
            key=config.UNI_SEPOLIA_API_KEY, url='https://api-sepolia.uniscan.xyz/api',
